...
def show_welcome_popup():
    ...
    if not st.session_state.hide_welcome_popup and st.session_state.show_popup:
        ...
        def welcome_dialog():
            ...
            st.markdown('<p><strong>Login Details:</strong> Enter a User ID (4-10 chars, ending with 2 digits, e.g., blaq01) to start. New users can create a unique ID.</p>', unsafe_allow_html=True)
            ...
            st.markdown('<p><strong>Chat Management:</strong> Type your message and click \'Send\' to interact with Aza Man. Use \'View State\' to see current session data.</p>', unsafe_allow_html=True)
